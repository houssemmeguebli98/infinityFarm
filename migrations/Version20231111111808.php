 ...
 */
final class Version20231111111808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materiel ADD idParc INT DEFAULT NULL, DROP idParcc');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materiel ADD idParcc INT NOT NULL, DROP idParc');
        $this->addSql('CREATE INDEX idParc ON materiel (idParcc)');
    }
}
