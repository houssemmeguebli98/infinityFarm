 ...
 */
final class Version20231111111159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materiel DROP FOREIGN KEY idParc');
        $this->addSql('ALTER TABLE materiel DROP FOREIGN KEY idParc');
        ...
        $this->addSql('ALTER TABLE materiel ADD CONSTRAINT idParc FOREIGN KEY (idParc) REFERENCES parc (idParc) ON UPDATE CASCADE ON DELETE CASCADE');
    }
