...
class RessourceController extends AbstractController
{
    ...
    #[Route('/{idres}', name: 'app_ressource_show', methods: ['GET'])]
    ...
    #[Route('/{idres}/edit', name: 'app_ressource_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idres}', name: 'app_ressource_delete', methods: ['POST'])]
