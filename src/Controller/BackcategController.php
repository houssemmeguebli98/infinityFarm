...
#[Route('/backcateg')]
class BackcategController extends AbstractController
{
    #[Route('/', name: 'app_backcateg_index', methods: ['GET'])]
    public function index(EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backoffice2/index.html.twig', [
            'categtrans' => $categtrans,
        ]);
    }

    #[Route('/new', name: 'app_backcateg_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_backcateg_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('backoffice2/new.html.twig', [
            'categtran' => $categtran,
            'form' => $form,
        ]);
    }

    #[Route('/{idCatTra}', name: 'app_backcateg_show', methods: ['GET'])]
    public function show(Categtrans $categtran): Response
    {
        return $this->render('backoffice2/show.html.twig', [
            'categtran' => $categtran,
        ]);
    }

    #[Route('/{idCatTra}/edit', name: 'app_backcateg_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Categtrans $categtran, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('backoffice2/edit.html.twig', [
            'categtran' => $categtran,
            'form' => $form,
        ]);
    }

    #[Route('/{idCatTra}', name: 'app_backcateg_delete', methods: ['POST'])]
